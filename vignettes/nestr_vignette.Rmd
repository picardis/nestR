...
The data is now ready to be analyzed to estimate the outcome of each nesting attempt. 

### Introducing the `estimate_outcomes` function
...
# Note that the JAGS estimation is done using the coda* functions, 
# so the coda diagnostics are available, e.g.,
