...
The `nestR` package provides functions to locate nesting attempts and estimate their outcome from bird GPS-tracking data. Being able to estimate reproductive outcome from GPS data bridges the gap between movement and reproductive fitness. 
...
knitr::include_graphics("img/nestR_flowchart.jpeg")
...
#knitr::include_graphics("img/nestR_explore_nests_params.jpg")
